...
struct battle_struct* CBattleSceneConstructor(struct battle_struct* param_1,
                                              struct megastruct* param_2);
undefined4 BattleStateManager(struct battle_struct* param_1, undefined4 param_2,
